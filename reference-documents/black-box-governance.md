...
**Critical limitation:** Abduction produces probable explanations, not definitive proof. The finding is **absence of verifiable evidence**, not evidence of absence. This distinction is crucial in contexts of uncertainty, particularly in medical and regulatory settings where, as economist Kenneth Arrow demonstrated, information asymmetry creates unique verification challenges that require special institutional safeguards. Abductive reasoning risks unfalsifiable speculation—inferring absence from patterns rather than proving it through evidence. This audit mitigates that risk through three safeguards: (1) abduction follows deductive reasoning establishing what *should* exist if claims were true, (2) empirical verification confirms the absence (OAIC searches, Senate testimony), and (3) conclusions remain falsifiable—TGA can refute findings by producing implementation records. The epistemic limitation persists: in contexts of information asymmetry, citizens cannot achieve perfect falsification of institutional claims. Transparent methodology and maintained falsifiability are the best available compromise between accountability research and scientific rigour.
