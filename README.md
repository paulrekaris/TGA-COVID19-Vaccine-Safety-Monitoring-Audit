...
- [Audit Overview](https://paulrekaris.github.io/TGA-COVID19-Vaccine-Safety-Monitoring-Audit/) – Provides a clear, non-technical overview of the audit and its findings.
...
Provisional approval under the Therapeutic Goods Act 1989 permits time-limited registration on the basis of preliminary clinical data while further evidence is generated. TGA guidance provides for enhanced post-market surveillance of provisionally registered medicines, alongside sponsor obligations including additional pharmacovigilance and evidence-generation requirements. In the COVID-19 vaccine context, the TGA’s enhanced monitoring approach was set out in its February 2021 COVID-19 Vaccine Safety Monitoring Plan.
...
- OAIC-directed TRIM searches (MR22/00538, September 2024), using eight search terms, identified zero documents demonstrating implementation of the enhanced-monitoring commitments; the broadest term returned 531+ containers, which TGA's own annotation records as unrelated to the safety monitoring plan. Comirnaty (July 2023) and Spikevax (April 2023) transitioned to full registration during the period the Plan was in effect
...
- Oversight bodies cannot assess whether enhanced monitoring commitments associated with provisional‑approval were systematically monitored and enforced.
...
- Whether compliance with sponsor conditions of provisional registration was verified and documented before vaccines transitioned to full registration.
...
- A concrete evidentiary platform on which ANAO could scope and conduct a dedicated performance audit of TGA’s COVID-19 vaccine pharmacovigilance system, including implementation of the enhanced post-market safety monitoring commitments accompanying the provisional-approval framework.
...
3. **Documents in scope have not been produced**: in FOI 25-0166 the TGA estimated that more than 399 documents comprising 3,926 pages fell within scope of the request, and refused access on practical-refusal grounds. The two FOI processes were differently framed: the OAIC-directed searches in MR22/00538 sought Plan implementation records across more than 531 containers and 2,218 pages and located none, while FOI 25-0166 sought documents of specified types relating to each objective and was refused before any document was examined.
...
- [Search Methodology Comparison](analysis/search-methodology-comparison.md) – Systematic comparison of this audit's output-specific search strategy (14 strategic terms) versus TGA's OAIC-directed searches (8 terms operating at Plan-title and audit level, not keyed to individual Plan outputs), documenting gaps in output-specific coverage including signal detection, AusVaxSafety coordination, and ICMRA sharing. Includes comparison table and gap analysis with full citations to TGA OAIC submission (September 2024, pp. 28-32) and audit methodology (Appendix A.2.2, pp. 77-78).

- [Surveillance Data Analysis](analysis/surveillance-analysis.md) – Systematic analysis of TGA's public COVID-19 vaccine safety reports (2021–2023) documenting zero Plan-framework references across 150+ public reports, notwithstanding [FOI 4029-03](primary-sources/foi/foi-4029/foi-4029-03.pdf), which shows TGA presented the Strategy 2.3 methodology to the Advisory Committee on Vaccines (September 2021). A methodology presented to an advisory committee does not evidence operation of the monitoring output: the audit classifies Strategy 2.3 Not Documented, and FOI 5275 (August 2024) confirms TGA does not hold the incidence data the methodology requires. Complete [FOI 4029 suite](primary-sources/foi/foi-4029) available in reference documents. Includes ISO 19011 audit methodology, ANAO performance-tracking gaps, and analysis of whether the OAIC-directed search scope captured the advisory-committee records that FOI 4029 shows exist.
...
Throughout this report, references to enhanced monitoring requirements and commitments under provisional approval mean those set out in the TGA's February 2021 COVID-19 Vaccine Safety Monitoring Plan. They do not refer to conditions of registration imposed on individual sponsors under the Therapeutic Goods Act 1989, which are separate and outside this audit's scope. This audit has not sought or reviewed the underlying sponsor documentation on which the TGA’s assessment of those conditions is based, and makes no finding as to its availability or completeness.
