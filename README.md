...
**Senate Community Affairs Legislation Committee Testimony - Supplementary Budget Estimates (9 October 2025)**
...
**Dr Dascombe's Response (Key Points):**

1. **"Ample documentation" exists** demonstrating compliance with principles and objectives of the Plan

2. **"Five key themes... essentially describe our day-to-day processes"** - characterised Plan as describing routine post-market surveillance

3. **148 safety signals investigated** for COVID-19 vaccines since February 2021

4. **57 occasions of regulatory actions** taken by TGA

5. **"No single spot evaluation report"** outlining benchmarking against Plan elements - instead "ample information in public domain"

6. **"Vast volume of documents"** would relate to day-to-day work since February 2021

7. **Acknowledged difficulty**: "There would be some difficulty in doing that" (producing documents organised by Plan)

**Senator Antic's Follow-up:**
- Noted documents exist that aren't in public domain
- Proposed putting on notice request for those documents
- Stated: "These are just documents that show that adverse events reports were being done. This is a public document which in its essence was designed to give confidence to the Australian public that this pharmacovigilance was taking place."

**Critical Admission:**
> "The five key themes outlined in that report **essentially describe our day-to-day processes**. This is our standard sort of process in terms of post market surveillance and pharmacovigilance."

This confirms monitoring was routine operations, not a distinct enhanced framework tracked against Plan objectives.

### Significance for Audit

Senate testimony confirms findings from FOI requests and OAIC reviews that Plan implementation was not tracked as a distinct framework despite Cabinet endorsement and provisional approval requirements. The characterisation of Plan strategies as "day-to-day processes" validates audit finding that enhanced monitoring was not implemented as operationally distinct from routine pharmacovigilance.
**Video recording (timestamped):**  
https://www.youtube.com/watch?v=YLFNBFdICU0&t=9040s (2:30:40–2:37:00)
...
**Key testimony:** TGA officials stated Plan implementation was "never systematically tracked" and monitoring occurred through "day-to-day processes" rather than distinct enhanced framework. Confirmed 148 safety signals investigated and 57 regulatory actions taken, but acknowledged no documentation links specific signals to specific actions.

**[Full testimony analysis and key exchanges →](reference-documents/senate-testimony-2025-10-09/README.md)**
...
Rekaris, P. (2026). Documentation Gap Analysis: Implementation Audit of TGA COVID-19 Vaccine Safety Monitoring Plan (Version 1.9). Zenodo. https://doi.org/10.5281/zenodo.17731054
...
- **Zenodo Archive:** [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.17731054.svg)](https://doi.org/10.5281/zenodo.17731054)  
