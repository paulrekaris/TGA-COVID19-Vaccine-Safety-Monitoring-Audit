...
For the audit-governance README the GitHub contributing badge is appropriate — it supports the open review architecture context. Remove the duplicate GitHub Release Management badge and fix the missing bracket on OSINT Foundation:
