...
2. Update version number and date in README and CITATIONS
...
6. Office of the Director of National Intelligence. (2024). *The IC OSINT Strategy 2024-2026*. <https://www.dni.gov/files/ODNI/documents/IC_OSINT_Strategy.pdf>

7. Office of the Director of National Intelligence. (2024). Intelligence Community Directive, 206: Sourcing Requirements for Disseminated Analytic Products. Technical Amendment <https://www.dni.gov/files/documents/ICD/ICD-206.pdf>

8. OSINT Foundation. (2024). *Principles for OSINT Professionals*. <https://www.osintfoundation.com/osint/Standards.asp>

9. Office of the Director of National Intelligence. (2024). *Intelligence Community Directive, ICS-206-01*. <https://www.dni.gov/files/documents/ICD/ICS-206-01.pdf>

**Version Control and Release Management:**

10. Preston-Werner, T. (2013). Semantic Versioning 2.0.0. <https://semver.org/spec/v2.0.0.html>

11. Keep a Changelog. <https://keepachangelog.com/>

12. GitHub. (2024). Managing releases in a repository. GitHub Docs. <https://docs.github.com/en/repositories/releasing-projects-on-github/managing-releases-in-a-repository>

13. GitHub. (2024). Reviewing the audit log for your organisation. GitHub Docs. <https://docs.github.com/en/organizations/keeping-your-organization-secure/managing-security-settings-for-your-organization/reviewing-the-audit-log-for-your-organization>

**Blockchain Verification and Archival:**

14. OpenTimestamps. (2024). OpenTimestamps: Scalable, trustless, distributed timestamping with Bitcoin. https://opentimestamps.org

15. Nakamoto, S. (2008). *Bitcoin: A Peer-to-Peer Electronic Cash System*. <https://bitcoin.org/bitcoin.pdf>

16. Williams, S. (2018). *Arweave Yellow Paper*. <https://www.arweave.org/yellow-paper.pdf>

17. Internet Archive. (2024). Wayback Machine. <https://web.archive.org/>
    
18. Zenodo Support. (n.d.). What is DOI versioning? <https://support.zenodo.org/help/en-gb/1-upload-deposit/97-what-is-doi-versioning>
