...
**Version:** 1.0   
**Date:** 24 March 2026   
**Location:** audit-governance/open-review-architecture.md   
...
| **Permanent archiving** | NLA (AWA), Zenodo, SSRN, SocArXiv, Mendeley Data, Arweave, blockchain. The work cannot be suppressed or retroactively altered |
...
| **Permanence** | Publisher-controlled | Multiple permanent archives, blockchain-anchored; survives platform changes or deletion |
...
**ISO 19011:2018 (Clauses 5.4, 6.4, 7.1)** requires audit findings be based on verifiable evidence and that the audit process be transparent and reproducible. This architecture meets those requirements by depositing all evidence in permanently archived, citable locations, documenting search methodologies and evidence hierarchies, and inviting independent replication and challenge.

**ANAO Better Practice (Performance Audit Process, 2023)** emphasises audits should be transparent, accountable, and open to scrutiny. This architecture makes all methods and evidence public, allows continuous scrutiny by any party, and creates a permanent record that cannot be retrospectively altered.

**ISO 15489-1:2016 (Clauses 4.2, 5.1)** requires records of activities be maintained with integrity and authenticity. Version control (via Git commit history), blockchain timestamping, and multi-layer archiving implement these requirements for the audit's own governance. The complete revision history is publicly accessible in the GitHub repository.

**Public Governance, Performance and Accountability Act 2013 (sections 37(2), 41)** requires Commonwealth entities to maintain proper records and be accountable for performance. This audit tests whether such records exist; the absence of documentation is itself a finding preserved for oversight bodies.
...
- **Permanence** — the work cannot be suppressed or retroactively altered
