...
- Add Key Finding to main README and scope note to ISO 19011 conformity assessment: Safety Plan design and accountability. The Plan did not align with ISO 19011:2018 auditability principles or ANAO better practice guidance—outputs unnumbered, strategies conflated with deliverables, no implementation framework. Structure did not support systematic tracking of commitments
- Added GAO Yellow Book 2018 citation with paragraph reference (para. 8.10) to methodology section in ISO 19011 conformity assessment and refrenced GAO in main README
...
- Updated to better capture average total daily statistics for total/unique views and total/unique clones
